...
import static cn.kspshare.mapper.KspUserDynamicSqlSupport.*;
...
@Mapper
public interface KspUserMapper {
    ...
    int insert(InsertStatementProvider<KspUser> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("KspUserResult")
    KspUser selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="KspUserResult", value = {
    ...
    List<KspUser> selectMany(SelectStatementProvider selectStatement);
    ...
    default DeleteDSL<MyBatis3DeleteModelAdapter<Integer>> deleteByExample() {
        return DeleteDSL.deleteFromWithMapper(this::delete, kspUser);
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default int insert(KspUser record) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default int insertSelective(KspUser record) {
        return insert(SqlBuilder.insert(record)
                .into(kspUser)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExample(KspUser record) {
        return UpdateDSL.updateWithMapper(this::update, kspUser)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default UpdateDSL<MyBatis3UpdateModelAdapter<Integer>> updateByExampleSelective(KspUser record) {
        return UpdateDSL.updateWithMapper(this::update, kspUser)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default int updateByPrimaryKey(KspUser record) {
        return UpdateDSL.updateWithMapper(this::update, kspUser)
                .set(username).equalTo(record::getUsername)
                .set(password).equalTo(record::getPassword)
                .set(nickname).equalTo(record::getNickname)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: ksp_user")
    default int updateByPrimaryKeySelective(KspUser record) {
        return UpdateDSL.updateWithMapper(this::update, kspUser)
                .set(username).equalToWhenPresent(record::getUsername)
                .set(password).equalToWhenPresent(record::getPassword)
                .set(nickname).equalToWhenPresent(record::getNickname)
