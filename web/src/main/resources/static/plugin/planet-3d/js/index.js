var container = document.getElementById("planet3d-container");
...
var material = new THREE.MeshLambertMaterial({
  color: 0xb8855c //星球颜色  0x0C2D4D
});

var planet = new THREE.Mesh(
  new THREE.IcosahedronGeometry(130, 3),//星球大小
  material
);
...
for (var p = 0; p < Math.PI * 2; p = p + Math.random() * 0.15) {
  var asteroid = new THREE.Mesh(
    new THREE.IcosahedronGeometry(9, 0),//碎石大小
    material
  );
  ...
  //碎石范围
  asteroid.position.set(240 * Math.sin(p) + rand, rand, 220 * Math.cos(p) + rand);
