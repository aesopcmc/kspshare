...
<head>
    ...
    <link href="${ctx.contextPath}/plugin/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
            ...
            <li>
                <div class="slide-caption">
                    <div class="slide-text">
                        <span>We Built Design Smart</span>
                        <h2><a href="#">welcome to smart antarctica</a></h2>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean conv
                            pretium laoreet proin et mauris ac massa.
                        </p>
                        <a href="#" class="btn btn-default">Read More</a>
                        <a href="#" class="btn btn-primary">Buy Now</a>
                    </div>
                </div>
                <img src="images/slider/slider-v1-img-1.jpg" alt="Slider Image">
            </li>
            <li>
                <div class="slide-caption">
                    <div class="slide-text">
                        ...
                        <h2><a href="#">welcome to smart antarctica</a></h2>
                        <p>
                            Sed gravida congue elit, ac vehicula ex facilisis ac. Etiam faucibus eros
                            in eros rhoncus, id condimentum lacus semper.
                        </p>
                        <a href="#" class="btn btn-default">Read More</a>
                        <a href="#" class="btn btn-primary">Buy Now</a>
                    </div>
                </div>
                <img src="images/slider/slider-v1-img-2.jpg" alt="Slider Image">
            </li>
            <li>
                <div class="slide-caption">
                    <div class="slide-text">
                        ...
                        <h2><a href="#">welcome to smart antarctica</a></h2>
                        <p>
                            Nulla maximus feugiat lorem, vel mattis risus fermentum at. Nulla facilisi.
                            Donec eget metus id massa iaculis porttitor justo.
                        </p>
                        <a href="#" class="btn btn-default">Read More</a>
                        <a href="#" class="btn btn-primary">Buy Now</a>
                    </div>
                </div>
                <img src="images/slider/slider-v1-img-3.jpg" alt="Slider Image">
            </li>
        </ul>
    </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-3">
                    <div class="counter-content text-center">
                        <h3 class="counter-digit"><span data-from="0" data-to="452" data-speed="800">452</span></h3>
                        <h4 class="counter-desc">Design Projects</h4>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3">
                    <div class="counter-content text-center">
                        <h3 class="counter-digit"><span data-from="0" data-to="125" data-speed="800">125</span>+</h3>
                        <h4 class="counter-desc">Team Members</h4>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3">
                    <div class="counter-content text-center">
                        <h3 class="counter-digit"><span data-from="0" data-to="468" data-speed="800">468</span></h3>
                        <h4 class="counter-desc">Cup Of Coffee</h4>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3">
                    <div class="counter-content text-center">
                        <h3 class="counter-digit counted"><span data-from="0" data-to="554" data-speed="800">554</span>+</h3>
                        <h5 class="counter-desc">Line of Codes</h5>
                    </div>
                </div>
            </div>
        </div>
...
<script src="${ctx.contextPath}/plugin/owl.carousel/owl.carousel.min.js"></script>
<script src="${ctx.contextPath}/plugin/jquery-countTo/jquery.countTo.js"></script>
<script src="${ctx.contextPath}/plugin/jquery.waypoints.min.js"></script>
